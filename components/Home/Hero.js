    ...
    <main className="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8 ">
      ...
      <div>
        ...
        <p className="text-lg mt-4 text-slate-600 max-w-xl">
          ...
          intelligence and computer vision to revolutionize the way we perceive
          and understand the world around us.
        </p>
        <div className="mt-6 flex flex-col sm:flex-row gap-3">
          <Link href="#" target="_blank" rel="noopener" className="bg-black text-white p-4 px-8 rounded hover:bg-white hover:border-2 hover:text-black">
            Try Now
          </Link>
          <Link
            size="lg"
